 ...
 *   HERMES_AGENT_NAME     Display name in asta UI   (default: Hermes)
 */
...
const HISTORY_FILE = path.join(HOME, ".hermes", "astad3d-history.json");
...
function startAdapter() {
  ...
  httpServer.listen(ADAPTER_PORT, "127.0.0.1", () => {
    ...
    console.log(`\nOpen asta → ws://localhost:${ADAPTER_PORT}\n`);
  });
