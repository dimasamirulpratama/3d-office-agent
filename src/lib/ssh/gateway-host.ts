...
const SSH_TARGET_ENV = "Asta_GATEWAY_SSH_TARGET";
const SSH_USER_ENV = "Asta_GATEWAY_SSH_USER";
const SSH_PORT_ENV = "Asta_GATEWAY_SSH_PORT";
const SSH_STRICT_HOST_KEY_ENV = "Asta_GATEWAY_SSH_STRICT_HOST_KEY_CHECKING";
