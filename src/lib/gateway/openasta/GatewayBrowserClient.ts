// Adapted from `Asta/Asta` `ui/src/ui/gateway.ts`.
// Source license: MIT. Last verified against Asta 2026.2.12
// (`f9e444dd56ccfc2271e8ae1729b7a14a55e1c11e`).
// Protocol v4 support (maxProtocol: 4) added 2026-05-17 to match Asta
...
const DEVICE_AUTH_STORAGE_KEY = "Asta.device.auth.v1";
...
const DEVICE_IDENTITY_STORAGE_KEY = "Asta-device-identity-v1";
...
export class GatewayBrowserClient {
  ...
  private queueConnect() {
    ...
    // incomplete (hasDevice=false), downgrades to webchat-ui, and Asta then
