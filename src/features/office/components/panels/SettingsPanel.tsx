...
type SettingsPanelProps = {
  ...
  remoteOfficeSourceKind: "presence_endpoint" | "Asta_gateway";
  ...
  onRemoteOfficeSourceKindChange: (kind: "presence_endpoint" | "Asta_gateway") => void;
    ...
    <div className="px-4 py-4">
      <div className="rounded-lg border border-cyan-500/10 bg-black/20 px-4 py-3">
        ...
        <input
          ...
          placeholder="Dimas Headquarters"
      ...
      <div className="mt-3 rounded-lg border border-cyan-500/10 bg-black/20 px-4 py-3">
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <div className="mt-1 text-[10px] text-white/75">
              Attach a second read-only office from either another asta or a remote Asta gateway.
            </div>
          </div>
          <span className="font-mono text-[10px] uppercase tracking-[0.14em] text-cyan-200/70">
        ...
        <div className="mt-3 grid gap-3">
          <div>
            ...
            <select
              ...
              onChange={(event) =>
                onRemoteOfficeSourceKindChange(
                  event.target.value as "presence_endpoint" | "Asta_gateway"
                )
              }
            ...
            >
              <option value="presence_endpoint">Remote asta presence endpoint</option>
              <option value="Asta_gateway">Remote Asta gateway</option>
            </select>
            <div className="mt-1 text-[10px] text-white/50">
              Use a presence endpoint when the other machine runs asta. Use gateway mode when the other machine only runs Asta.
            </div>
          </div>
          <div>
            <div className="mb-1 text-[10px] uppercase tracking-[0.14em] text-cyan-100/65">
          ...
          {remoteOfficeSourceKind === "presence_endpoint" ? (
            <>
              <div>
                ...
                />
                <div className="mt-1 text-[10px] text-white/50">
                  Studio polls this endpoint server-side when the other machine is also running asta.
                </div>
              </div>
              <div>
                <div className="mb-1 text-[10px] uppercase tracking-[0.14em] text-cyan-100/65">
            ...
            <>
              <div>
                ...
                />
                <div className="mt-1 text-[10px] text-white/50">
                  asta connects from the browser directly to the remote Asta gateway and derives a read-only presence snapshot.
                </div>
              </div>
              <div>
                <div className="mb-1 text-[10px] uppercase tracking-[0.14em] text-cyan-100/65">
