...
const SOUNDasta_PLAYBACK_STARTED_EVENT = "soundasta:playback-started";

const emitPlaybackStarted = () => {
  if (typeof window === "undefined") return;
  window.dispatchEvent(
    new CustomEvent(SOUNDasta_PLAYBACK_STARTED_EVENT, {
...
export const SOUNDasta_PLAYBACK_STARTED_EVENT_NAME = SOUNDasta_PLAYBACK_STARTED_EVENT;
