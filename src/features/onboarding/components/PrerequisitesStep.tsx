...
const prerequisites = [
  {
    label: "Asta installed",
    detail: "Install via npm, pnpm, or from source",
    link: "https://docs.Asta.ai",
    linkLabel: "Installation docs",
  },
  {
    label: "Gateway running",
    detail: "Start with: Asta gateway start",
    command: "Asta gateway start",
  },
  {
    label: "Gateway URL and token",
    detail: "Found in ~/.Asta/Asta.json or your remote setup",
  },
  {
    label: "Node.js 20+",
    detail: "Required for running asta locally",
...
export const PrerequisitesStep = () => (
  <div className="space-y-2.5">
    <p className="text-[13px] leading-5 text-white/70">
      ...
      Asta running, you can skip this step.
    </p>
    ...
    <p className="text-[10px] leading-4 text-white/40">
      ...
      or{" "}
      <a
        href="https://discord.com/invite/astad"
        target="_blank"
        rel="noopener noreferrer"
        className="text-amber-300/70 hover:text-amber-200"
      >
