    ...
    >
        ...
        {bottomStyle === "shorts" ? (
          <>
            <mesh position={[0, 0.03, 0]}>
              <capsuleGeometry args={[0.03, 0.045, 16, 16]} />
              <meshLambertMaterial color={trouserColor} />
            </mesh>
            <mesh position={[0, -0.035, 0]}>
              <capsuleGeometry args={[0.026, 0.045, 16, 16]} />
          ...
          <>
            ...
            {bottomStyle === "cuffed" ? (
              <mesh position={[0, -0.05, 0]}>
                <torusGeometry args={[0.032, 0.007, 12, 16]} />
                <meshLambertMaterial color="#d1d5db" />
              </mesh>
            ) : null}
          </>
        )}
        <mesh position={[0, -0.085, 0.018]} rotation={[Math.PI / 2, 0, 0]}>
          <capsuleGeometry args={[0.03, 0.055, 16, 16]} />
      ...
      {showBackpack ? (
        <group position={[0, 0.28, -0.08]}>
          <mesh>
            <capsuleGeometry args={[0.06, 0.11, 16, 16]} />
            <meshLambertMaterial color={accessoryColor} />
          </mesh>
          <mesh position={[-0.05, 0.02, 0.035]}>
            <capsuleGeometry args={[0.007, 0.13, 8, 8]} />
      ...
      <mesh position={[0, 0.28, 0]}>
        <capsuleGeometry args={[0.085, 0.11, 24, 24]} />
        <meshLambertMaterial ref={bodyMatRef} color={topColor} />
      </mesh>
      {topStyle === "hoodie" ? (
        <>
          <mesh position={[0, 0.36, -0.038]} rotation={[0.4, 0, 0]}>
            <torusGeometry args={[0.07, 0.022, 14, 20]} />
            <meshLambertMaterial color={topColor} />
          </mesh>
          <mesh position={[0, 0.22, 0.07]}>
            <capsuleGeometry args={[0.02, 0.05, 14, 14]} />
      ...
      {topStyle === "jacket" ? (
        <>
          <mesh position={[0, 0.28, 0.018]}>
            <capsuleGeometry args={[0.088, 0.108, 24, 24]} />
            <meshLambertMaterial color={topAccentColor} />
          </mesh>
          <mesh position={[0, 0.28, 0.075]}>
            <capsuleGeometry args={[0.01, 0.14, 10, 10]} />
      ...
      <group ref={rightArmRef} position={[-0.12, 0.28, 0]}>
        <mesh position={[0, -0.07, 0]}>
          <capsuleGeometry args={[0.026, 0.11, 16, 16]} />
          <meshLambertMaterial color={sleeveColor} />
        </mesh>
        {topStyle === "hoodie" ? (
          <mesh position={[0, -0.125, 0]}>
            <torusGeometry args={[0.026, 0.007, 12, 16]} />
            <meshLambertMaterial color={cuffColor} />
          </mesh>
        ) : null}
      ...
      <mesh position={[0, 0.39, 0]}>
        <cylinderGeometry args={[0.03, 0.035, 0.045, 16]} />
        <meshLambertMaterial color={skin} />
      </mesh>
      <mesh position={[0, 0.485, 0]} scale={[1, 1.05, 0.95]}>
        <sphereGeometry args={[0.086, 32, 32]} />
        <meshLambertMaterial color={skin} />
      </mesh>
      {hairStyle === "short" ? (
        <mesh position={[0, 0.52, -0.008]} scale={[1.04, 1.05, 1.04]}>
          <sphereGeometry args={[0.086, 32, 32, 0, Math.PI * 2, 0, Math.PI / 1.85]} />
      ...
      {hairStyle === "parted" ? (
        <group position={[0, 0.52, 0]}>
          ...
          <mesh position={[-0.03, 0.03, 0.05]} rotation={[0.2, 0, -0.3]}>
            <capsuleGeometry args={[0.015, 0.05, 16, 16]} />
            <meshLambertMaterial color={hairColor} />
          </mesh>
        </group>
      ) : null}
      {hairStyle === "spiky" ? (
        <group position={[0, 0.52, 0]}>
          ...
          <mesh position={[-0.035, 0.06, 0.02]} rotation={[-0.2, 0, -0.35]}>
            <coneGeometry args={[0.02, 0.06, 16]} />
            <meshLambertMaterial color={hairColor} />
          </mesh>
          <mesh position={[0, 0.075, 0.01]} rotation={[-0.15, 0, 0]}>
      ...
      {hatStyle === "cap" ? (
        <group position={[0, 0.535, 0]}>
          <mesh position={[0, 0, 0]}>
            <sphereGeometry args={[0.09, 24, 24, 0, Math.PI * 2, 0, Math.PI / 2.1]} />
            <meshLambertMaterial color={accessoryColor} />
          </mesh>
          <mesh position={[0, -0.01, 0.07]} rotation={[0.2, 0, 0]}>
            <cylinderGeometry args={[0.06, 0.065, 0.008, 24, 1, false, 0, Math.PI]} />
            <meshLambertMaterial color={accessoryColor} />
          </mesh>
        </group>
      ) : null}
      {hatStyle === "beanie" ? (
        <mesh position={[0, 0.53, 0]} scale={[1.05, 1.14, 1.05]}>
          <sphereGeometry args={[0.088, 24, 24, 0, Math.PI * 2, 0, Math.PI / 1.8]} />
          <meshLambertMaterial color={accessoryColor} />
        </mesh>
      ) : null}
      {showHeadset ? (
        <group position={[0, 0.49, 0]}>
          <mesh rotation={[0, 0, Math.PI / 2]}>
            <torusGeometry args={[0.098, 0.007, 12, 28, Math.PI]} />
            <meshLambertMaterial color="#94a3b8" />
          </mesh>
          <mesh position={[-0.095, 0, 0]} rotation={[0, 0, Math.PI / 2]}>
            <cylinderGeometry args={[0.022, 0.022, 0.016, 16]} />
          ...
          <mesh position={[0.08, -0.045, 0.055]} rotation={[0.25, 0.25, -0.4]}>
            <capsuleGeometry args={[0.005, 0.05, 8, 8]} />
            <meshLambertMaterial color="#94a3b8" />
          </mesh>
        </group>
      ) : null}
      <mesh ref={leftBrowRef} position={[-0.035, 0.52, 0.076]}>
        <capsuleGeometry args={[0.0035, 0.028, 8, 8]} />
        <meshBasicMaterial color="#342016" />
      </mesh>
      <mesh ref={rightBrowRef} position={[0.035, 0.52, 0.076]}>
        <capsuleGeometry args={[0.0035, 0.028, 8, 8]} />
        <meshBasicMaterial color="#342016" />
      </mesh>
      <mesh ref={leftEyeRef} position={[-0.034, 0.485, 0.078]}>
        <sphereGeometry args={[0.012, 16, 16]} />
        <meshBasicMaterial color="#1a1a2e" />
      </mesh>
      <mesh ref={rightEyeRef} position={[0.034, 0.485, 0.078]}>
        <sphereGeometry args={[0.012, 16, 16]} />
        <meshBasicMaterial color="#1a1a2e" />
      </mesh>
      <mesh ref={leftEyeHighlightRef} position={[-0.031, 0.489, 0.086]}>
        <sphereGeometry args={[0.0035, 10, 10]} />
        <meshBasicMaterial color="#fff" />
      </mesh>
      <mesh ref={rightEyeHighlightRef} position={[0.037, 0.489, 0.086]}>
        <sphereGeometry args={[0.0035, 10, 10]} />
        <meshBasicMaterial color="#fff" />
      </mesh>
      {showGlasses ? (
        <group position={[0, 0.485, 0.084]}>
          <mesh position={[-0.034, 0, 0]}>
            <torusGeometry args={[0.018, 0.0025, 12, 20]} />
      ...
      <mesh ref={mouthRef} position={[0, 0.444, 0.08]} rotation={[0, 0, Math.PI / 2]}>
        <capsuleGeometry args={[0.003, 0.018, 10, 10]} />
        <meshBasicMaterial color="#9c4a4a" />
      </mesh>
      <mesh
        ref={leftMouthCornerRef}
        position={[-0.025, 0.445, 0.08]}
        visible={false}
      >
