...
> Third concrete office-system feature for asta, building on existing standup support and extending it into a generalized meeting workflow model.
...
asta already has meaningful meeting-related pieces:
...
This is important because asta already has the skeleton of a meeting system.
