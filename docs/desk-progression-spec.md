...
> Fifth concrete office-system feature for asta, connecting visible office presence to role maturity, permissions, and capability growth.
...
Desk progression should integrate with real asta systems rather than sit beside them.

### Permissions

asta already has permission and approval surfaces.
