...
> Seventh concrete office-system feature for asta, formalizing operational agent states before any deeper simulation or affective layer is introduced.
...
asta already visualizes activity, presence, and meeting participation.
...
asta already uses simpler presence states such as:
...
- derived state from asta activity
...
- asta shows the public office state plus optional note/reason
