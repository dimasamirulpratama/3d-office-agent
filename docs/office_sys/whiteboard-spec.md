...
> Second concrete office-system feature for asta, designed to work alongside the bulletin board.
...
The whiteboard should integrate with what asta already has.
...
- use asta's own whiteboard model as the primary domain model
...
- asta needs stronger links to meetings, bulletin board items, tasks, agents, and sessions
...
- the system works independently of Asta-specific behavior
...
The whiteboard should become asta’s active planning surface.
