...
> Fourth concrete office-system feature for asta, completing the first real office loop: plan, coordinate, execute, review.

## Goal

Add a QA department workflow to asta so the office can visibly review, test, triage, and sign off on work before it is treated as complete.
...
The QA department should plug into systems asta already has.
...
asta already has approval-related surfaces.
...
asta already has review-adjacent UI, including GitHub-oriented immersive screens.
